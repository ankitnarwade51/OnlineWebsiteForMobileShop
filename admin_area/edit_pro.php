...
<tr align="center">	
<td colspan="2"><h2>Update Or Edit product</td>
</tr>
...
<td><input type="file" name="product_img1"/><br><br><img src="product_images/<?php echo $p_image1;   ?>" width="60" height="60"></td>
</tr>

<tr>	
<td align="right"><b>Product Image 2</td>
<td><input type="file" name="product_img2"/><br><br><img src="product_images/<?php echo $p_image2;   ?>" width="60" height="60"></td>
</tr>


<tr>	
<td align="right"><b>Product Image 3</td>	
<td><input type="file" name="product_img3"/><br><br><img src="product_images/<?php echo $p_image3;   ?>" width="60" height="60"></td>
</tr>


<tr>
<td align="right"><b>Product Price</td>	
<td><input type="text" name="product_price"size="50" value="<?php echo $p_price; ?>"/></td>
</tr>

<tr>	
<td align="right"><b>Product Description</td>	
<td><textarea name="product_desc" cols="40" rows="20"><?php echo $p_desc; ?></textarea></td>
</tr>
